...
<html>
 <head>
		...
		<script type="text/javascript">
			function doSubmit(){
				document.forms[0].action = document.forms[0].action + "?operate=doSubmit";
	...
	<body>
		<form action="engageresume.do" method="post">
			<table width="100%">
				...
				<tr>
					<td align="right">
						<input type="radio"  name="pass_results" value="不通过" />不通过
						<input type="radio"  name="pass_results" value="通过"  checked="checked" />通过
						<input type="button" value="确认" class="BUTTON_STYLE1"
							onclick="doSubmit()">
							<input type="hidden" name="res_id" value="${resumes.res_id }" />
...
<table class="TABLE_STYLE1" border="1" width="100%" cellpadding=0
				...
				<tr>
					...
					<td class="TD_STYLE2">
						<input type="text" name="check_time" readonly="true"  value="${list.check_time}" class="INPUT_STYLE2" readonly="true">
					</td>
				</tr>
				<tr>
					<td class="TD_STYLE1">
				...
				<tr>
					...
					<td class="TD_STYLE2" colspan="7">
						<textarea name="pass_checkComment" class="TEXTAREA_STYLE1" rows="4" readonly="true">${list.check_comment }</textarea>
					</td>
				</tr>
				<tr>
					<td class="TD_STYLE1">
					...
					<td class="TD_STYLE2" colspan="7">
						<textarea name="pass_passComment" class="TEXTAREA_STYLE1" rows="4" ></textarea>
					</td>
				</tr>
			</table>
		</form>
