	...
	<body>
		<form action="engageresume.do" method="post">
			<table width="100%">
				<tr>
					<td>
						<font color="#0000CC">您正在做的业务是：人力资源--招聘管理--录用查询 </font>
					</td>
				</tr>
				<tr>
					<td align="right">
			...
			<table class="TABLE_STYLE1" border="1" width="100%" cellpadding=0
				...
				<tr>
					...
					<td class="TD_STYLE2" colspan="7">
						<textarea name="pass_checkComment" class="TEXTAREA_STYLE1" rows="4" >${resumes.pass_checkComment }</textarea>
					</td>
				</tr>
				<tr>
					<td class="TD_STYLE1">
					...
					<td class="TD_STYLE2" colspan="7">
						<textarea name="pass_passComment" class="TEXTAREA_STYLE1" rows="4" >${resumes.pass_passComment }</textarea>
					</td>
				</tr>
			</table>
		</form>
