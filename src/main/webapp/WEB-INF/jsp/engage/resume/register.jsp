...
<html>
	...
	<body onload="check()">
		<form action="engageresume.do" enctype="multipart/form-data"  method="post">
			<table width="100%">
				<tr>
					<td>
			...
			<table class="TABLE_STYLE1" border="1" width="100%" cellpadding=0
				...
				<tr class="TR_STYLE1">
					...
					<td width="17%">
						<select Class="SELECT_STYLE1"
							...
							<c:forEach items="${majorKinds }" var="majorkinds">
								<option value="${majorkinds.major_kind_id}/${majorkinds.major_kind_name}">${majorkinds.major_kind_name }</option>
							</c:forEach>
						</select>
					</td>
					<td width="9%" nowrap class="TD_STYLE1">
						职位名称
					</td>
					<td width="17%">
						<select Class="SELECT_STYLE1" name="human_major_name"  id="majorName">
				...
				<tr>
					...
					<td class="TD_STYLE1">
						<input type="text" name="regist_time" readonly="true"   class="INPUT_STYLE2"  id="nowTime">
					</td>
				</tr>
				<tr>
					<td class="TD_STYLE1">
