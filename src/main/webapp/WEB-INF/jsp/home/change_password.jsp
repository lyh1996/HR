...
<table width="100%">
  ...
  <tr>
    ...
    <td width="80%" class="TD_STYLE2">
    	<input name="UName" type="text" class="INPUT_STYLE1" style="background-color: #DEEBF7" />
    </td>
  ...
  <tr>
    ...
    <td class="TD_STYLE2">
    	   <input name="old_u_password" type="password" class="INPUT_STYLE1" style="background-color: #DEEBF7" />
    </td>
  </tr>
  <tr>
    <td class="TD_STYLE1">新密码</td>
    <td class="TD_STYLE2">
    	   <input name="UPassword" type="password" class="INPUT_STYLE1" style="background-color: #DEEBF7" />
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td></td>
    <td align="center"><input type="button" value="确认" class="BUTTON_STYLE1" onclick="javascript:doEditPwd();"> &nbsp;
