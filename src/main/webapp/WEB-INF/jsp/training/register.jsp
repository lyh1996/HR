	...
	<form name="form1" method="post" action="training.do">
		...
		<table width="100%" border="1" cellpadding=0 cellspacing=1
			...
			<tr>
				...
				<td colspan="5" class="TD_STYLE2"><input type="text"
					name="human_id" class="INPUT_STYLE2" value="${list.human_id }" readonly="true" /></td>
					<td width="11%" class="TD_STYLE1">培训时间</td>
					<td width="13%" class="TD_STYLE2">
						<input type="text" name="training_time" class="INPUT_STYLE2" id="date_start" />
					</td>
			</tr>
			<tr>
				...
				<td width="14%" class="TD_STYLE2"><select
					NAME="training_item" class="SELECT_STYLE1">
			...
			<tr>
				...
				<td class="TD_STYLE2"><input type="text" name="training_hour"
					class="INPUT_STYLE2" /></td>
				<td class="TD_STYLE1">培训成绩</td>
				<td class="TD_STYLE2"><select NAME="training_degree"
					class="SELECT_STYLE1">
