...
<table width="100%" >
  ...
  <tr>
    ...
    <input type="button" value="上传照片" class="BUTTON_STYLE1" onclick="doUpLoadPhoto2('check');">
	<input type="button" value="上传附件" class="BUTTON_STYLE1" onclick="toUpLoadAttach2('check');">
      <input type="button" value="完成" class="BUTTON_STYLE1" onclick="javascript:finish2();"></td>
  </tr>
   <tr>
