...
<table width="100%" >
  ...
  <tr>
    <td width="49%"><p style="color: red;"> 您确认删除 ${mch_id } 这条调动信息吗?</p> </td>
    <td width="51%" align="right"><input type="button" value="删除" class="BUTTON_STYLE1" onclick="javascript:doDel(${mch_id})">
