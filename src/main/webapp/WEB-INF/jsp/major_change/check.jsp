	...
	<body>
		<form method="post" action="majorchange.do">
			<table width="100%">
				...
				<tr>
					<td align="right">
					<input type ="radio" name ="check_status" value ="1" checked ="yes"/>通过
							<input type ="radio" name ="check_status" value ="0" />不通过
						<input type="submit"  value="确认"
					class="BUTTON_STYLE1" onclick="javascript:doEdit(${list.mch_id});">
			...
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<td class="TD_STYLE1">
					...
					<td class="TD_STYLE2">
						 	<input type="text" name="checker" class="INPUT_STYLE2"
					...
					<td class="TD_STYLE2">
						<input type="text" name="check_time" class="INPUT_STYLE2" value="${currentTime}"
						 readonly="true"/> 
					</td>
				</tr>
				<tr>
