...
font-family : "Arial";
font-size : 14px;}
.leaf A:link { color:blue; text-decoration: none;}
.leaf A:visited { color: pink; text-decoration: none; }
...
<BODY LINK="#FFFFFF" marginwidth="1" marginheight="1" onResize="frameResized();" topmargin="0" leftmargin="0" bgcolor="#f1f1f1" text="#FFFFFF" vlink="#FFFFFF" alink="#FFFFFF" background="images/7.jpg">
<DIV ID="menuTop">&nbsp;
</DIV>
<SCRIPT LANGUAGE="JavaScript">
<!--
