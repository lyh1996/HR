...
<table width="830" height="400" border="0" align="left">
  ...
  <td width="120"><div align="center">
	<a target="a" onMouseOver="MM_swapImage('image0','','images/images/config1.gif',1)" onMouseOut="MM_swapImgRestore()">
      <div align="right"><img src="images/images/config.gif" width="55" height="55" name="image0" alt="¿Í»§»¯ÉèÖÃ"></div>
      <div align="center">
    </div></td>
    <td width="120" height="38">
	  <div align="center"><a target="a" onMouseOver="MM_swapImage('image1','','images/images/file1.gif',1)" onMouseOut="MM_swapImgRestore()">        
	    <div align="right"><img src="images/images/file.gif" width="55" height="55" name="image1" alt="ÈËÁ¦×ÊÔ´µµ°¸¹ÜÀí"></div>
	  </div></td>
    <td width="118">
	  <a target="a" onMouseOver="MM_swapImage('image2','','images/images/salary_standard1.gif',1)" onMouseOut="MM_swapImgRestore()">
      <div align="right"><img src="images/images/salary_standard.gif" width="55" height="55" name="image2" alt="Ð½³ê±ê×¼¹ÜÀí"></div></td>
    <td width="120">
	  <a target="a" onMouseOver="MM_swapImage('image3','','images/images/salary1.gif',1)" onMouseOut="MM_swapImgRestore()">
      <div align="right"><img src="images/images/salary.gif" width="55" height="55" name="image3" alt="Ð½³ê·¢·Å¹ÜÀí"></div></td>
    <td width="120">
	  <a target="a" onMouseOver="MM_swapImage('image4','','images/images/major_change1.gif',1)" onMouseOut="MM_swapImgRestore()">
      <div align="right"><img src="images/images/major_change.gif" width="55" height="55" name="image4" alt="µ÷¶¯¹ÜÀí"></div></td>
  </tr>
  <tr>
  ...
  <td width="120">
	    ...
	    <div align="right"><img src="images/images/training.gif" width="55" height="55" name="image5" alt="ÅàÑµ¹ÜÀí"></div></td>
    <td width="120" height="55"><div align="center">
	  ...
	  <div align="right"><img src="images/images/bonus.gif" width="55" height="55" name="image6" alt="¼¤Àø¹ÜÀí"></div></td>
    <td width="118">
      <a target="a" onMouseOver="MM_swapImage('image7','','images/images/engage1.gif',1)" onMouseOut="MM_swapImgRestore()">
      <div align="right"><img src="images/images/engage.gif" width="55" height="55" name="image7" alt="ÕÐÆ¸¹ÜÀí"></div></td>
    <td width="120"><div align="center">
      <a target="a" onMouseOver="MM_swapImage('image8','','images/images/export1.gif',1)" onMouseOut="MM_swapImgRestore()">
	   <div align="right"><img src="images/images/export.gif" width="55" height="55" name="image8" alt="±ê×¼Êý¾Ý±¨±í"></div>
	   <div align="center">
   </div></td>
