...
function initialise() {
	...
	theMenu.defaultTarget = "mainFrame";
...
if (theBrowser.IE){
	self.document.writeln('<frameset rows="*" cols="220,*" border="0"  noresize framespacing="2">'); 
	self.document.writeln('<frame name="menu" src="menu"  border="0" scrolling="auto" marginwidth="0"  leftmargin="0" marginheight="0" APPLICATION="yes">');
	...
	self.document.writeln('</frameset>');
		...
		self.document.writeln('<frame name="menu" src="menu"  border="0" scrolling="auto" marginwidth="0"  leftmargin="0" marginheight="0" APPLICATION="yes">');
		self.document.writeln('<frame name="text" src="tree"  frameborder="no"  marginwidth="0" marginheight="0" APPLICATION="yes">');
		self.document.writeln('</frameset>');
