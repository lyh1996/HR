		...
		<table width="100%">
			...
			<tr>
				<td align="right"><input type="submit" name="insert" value="提交"
					class="BUTTON_STYLE1" onclick="javascript:doEdit(${list.fsk_id});">
		...
		<table width="100%" border="1" cellpadding=0 cellspacing=1
			...
			<tr>
				...
				<td class="TD_STYLE2"><textarea name="second_salary_id"
						class="TEXTAREA_STYLE1" rows="4">${list.second_salary_id }</textarea></td>
			</tr>
			<tr>
				<td class="TD_STYLE1">销售责任人编号（多个编号之间请用"半角逗号"加"一个空格"隔开，如", "）</td>
				<td class="TD_STYLE2"><textarea name="second_sale_id"
						class="TEXTAREA_STYLE1" rows="4">${list.second_sale_id }</textarea></td>
			</tr>
		</table>
	</form>
</body>
