...
<table width="100%"  border="1" cellpadding=0 cellspacing=1 bordercolorlight=#848284 bordercolordark=#eeeeee class="TABLE_STYLE1">
  <tr>
    ...
    <td width="81%" class="TD_STYLE2"><select name="first_kind_name" class="SELECT_STYLE2">
  ...
  <tr>
    ...
    <td class="TD_STYLE2"><select name="second_kind_name" class="SELECT_STYLE2">
    		<c:forEach items="${ list2 }" var="configfilesecondkinds">
					<option value="${configfilesecondkinds.second_kind_id }/${configfilesecondkinds.second_kind_name }">${configfilesecondkinds.second_kind_id }/${configfilesecondkinds.second_kind_name }</option>
			</c:forEach>
    </select></td>
  </tr>
  <tr>
